...
/** Stores a Rust object, and returns an id by which the app may refer
 * to it in later method calls */
...
function forwardError(callId: number, error: any) {
    ...
    // otherwise this was probably the result of a Rust call returning
    // `Err`, forward it.
                    ...
                    Promise.resolve(res)
                        .then(val => {
                            ...
                            if (req.command === "new" || req.retType === "obj") {
                                ...
                                } // TODO: arrays of mixed types not supported!
